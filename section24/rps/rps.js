//did not edit this since given by author
...
function test(name, expected, actual) {
  if (expected === actual) {
    return name +':Test Passed, expected result is '+expected+' and actual result is '+actual;
  } else {
    return name+':Test failed;Expected:'+expected+' Actual: '+actual;
  }
}
const tie = 'Tie';
...
//edge conditions
console.log(test('Test:Edge conditions:', 'Player 2 made an invalid selection.', rps('r', 'x')));
console.log(test('Test:Edge conditions:', 'Player 1 made an invalid selection.', rps('a', 'r')));
console.log(test('Test:Edge conditions:', 'Player 1 made an invalid selection.', rps('o', 'x')));